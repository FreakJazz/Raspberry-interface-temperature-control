...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(325, 314)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.aceptar = QtWidgets.QPushButton(self.centralwidget)
        self.aceptar.setGeometry(QtCore.QRect(100, 230, 131, 31))
        self.aceptar.setObjectName("aceptar")
        self.frame_3 = QtWidgets.QFrame(self.centralwidget)
        self.frame_3.setGeometry(QtCore.QRect(10, 10, 301, 211))
        self.frame_3.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_3.setObjectName("frame_3")
        self.graphic = QtWidgets.QGraphicsView(self.frame_3)
        self.graphic.setGeometry(QtCore.QRect(30, 10, 256, 192))
